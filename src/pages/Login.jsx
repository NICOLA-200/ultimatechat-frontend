...
export default function Login() {
  ...
  return (
    <div className=" flex justify-center items-center w-full h-[100vh] py-20 sm:py-0 bg-zinc-200 relative">
      <div className="flex items-center w-[320px] sm:my-0  bg-white shadow-lg rounded-xl flex-col space-y-4 relative h-auto p-10 justify-center">
        <div className=" absolute h-[50%] w-full top-0 z-0 ">
          <div className="bg-yellow-400 h-[80%] w-full"></div>
          <div className="bg-yellow-400 h-0 w-0 border-b-[100px] border-l-[320px]  border-b-white  border-l-transparent"></div>
        </div>
        ...
        <form
          ...
          className="flex flex-col justify-center pb-3 gap-9 relative"
        >
